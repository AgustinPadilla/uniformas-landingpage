...
export const LogoSection = () => {
  return (
    <section className='ColoredSection bg-purple-300  items-center'>
      <article className='flex flex-col max-w-2xl items-center animate-fade-right animate-once animate-ease-out'>
      ...
      <picture className='invert drop-shadow-2xl animate-fade-down animate-once animate-ease-out'>
        <Logo w={300} h={400} />
      </picture>
    </section>
  )
